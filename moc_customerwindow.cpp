...
template <> constexpr inline auto CustomerWindow::qt_create_metaobjectdata<qt_meta_tag_ZN14CustomerWindowE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        "CustomerWindow",
        "onViewAccountsClicked",
        "",
        "onTransferClicked",
        "onChangePasswordClicked",
        "onGenerateDynamicPasswordClicked",
        "onUpdateInfoClicked",
        "onLogoutClicked",
        "onAccountSelected",
        "QListWidgetItem*",
...
void CustomerWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->onViewAccountsClicked(); break;
        case 1: _t->onTransferClicked(); break;
        case 2: _t->onChangePasswordClicked(); break;
        case 3: _t->onGenerateDynamicPasswordClicked(); break;
        case 4: _t->onUpdateInfoClicked(); break;
        case 5: _t->onLogoutClicked(); break;
        case 6: _t->onAccountSelected((*reinterpret_cast< std::add_pointer_t<QListWidgetItem*>>(_a[1]))); break;
        default: ;
        }
    }
}
