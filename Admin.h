...
public:
    ...
    void addAccountToCustomer(Customer *customer, int accountType, const string &accNum, const string &cardNum, const string &sheba, const string &pin, const string &pin2);
